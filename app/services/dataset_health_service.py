...
def analyze_dataset_health(db: Session, model_id: str) -> dict:
    """Analyze production logs for missing values, class imbalance, outliers (IQR), and duplicates."""
    ...
    # IQR bounds come from the baseline probe distribution when one exists,
    # falling back to the production distribution itself otherwise.
    session = (
