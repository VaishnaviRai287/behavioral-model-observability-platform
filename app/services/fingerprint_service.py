...
def get_uncertainty_regions(db: Session, fingerprint_id: str) -> list[dict]:
    """Detect low-confidence feature-space regions by fitting a decision tree over probe results."""
    ...
    # A region counts as "uncertain" when confidence is low and variance is
    # high relative to the rest of the tree's leaves.
